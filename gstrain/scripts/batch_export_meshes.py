...
if __name__ == "__main__":
    MODEL_PATH = "/home/hussein_essam/gs-workspace/VRoom/outputs/office3dgsvroomNotDevaOnlyPoint3D"
    SOURCE_PATH = "/home/hussein_essam/gs-workspace/VRoom/gstrain/datasets/replica/office_0"
    ITERATION = 30000
    
    # Labels found in the checkpoint
    LABELS = [
        3, 4, 5, 7, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19, 20, 21, 22, 23, 
        24, 26, 27, 28, 30, 32, 33, 34, 35, 36, 37, 38, 39, 40, 42, 44, 
        46, 48, 49, 50, 51, 54, 55, 56, 57, 58, 61, 63, 64, 66
    ]
