...
class TrainingConfig:
    ...
    overlap: bool = False
    densification_budget_ratio: float = 0.03
    densification_min_budget: int = 8
    densification_cell_factor: float = 1.5
    densification_support_threshold: int = 2
    densification_novelty_scale: float = 1.0
    densification_overlap_radius: float = 0.75
    densification_novelty_chunk: int = 2048
